...
<html lang="en">
  ...
  <body>
    ...
    <div id="match_detail_container" style="background-color:aqua;">
        ...
        <tr>
          <td colspan="6" align="center"><span id="location">${match.place }</span><br /><br /></td>
        </tr>
        <tr>
          <td colspan="3" align="center" width="50%">
            <img src="https://yt3.ggpht.com/-TrtEHOgcMFE/AAAAAAAAAAI/AAAAAAAAAAA/K547x_dy1bY/s900-c-k-no/photo.jpg" alt="" width="200" height="200" id="img3" />
            <br /><span id="home_short_name">${match.home.shortName}</span>
          </td>
          <td colspan="3" align="center" width="50%">
            <img src="http://blogs-images.forbes.com/mikeozanian/files/2013/01/296px-Manchester_United_FC_crest.svg_.png" alt="" width="200" height="200" id="img4" />
            <br /><span id="away_short_name">${match.away.shortName }</span>
            </td>
        </tr>
        <tr>
          <td colspan="6" align="center"><br />${match.date } <br /><br /></td>
        </tr>
        ...
        <tr>
          ...
          <td align="right"><img src="https://fbcdn-profile-a.akamaihd.net/hprofile-ak-ash1/t1.0-1/c0.4.200.200/p200x200/1904112_670798462980493_1480381048_n.jpg" alt="" width="100" height="100" id="img1" /></td>
    ...
    <div id="comment_container">
      ...
      <div class="comment_box_wrapper" style="margin-bottom:100px;">
        <textarea class="form-control" id="textarea" rows="6" placeholder="Comment"></textarea>
      <br />
